...
// Begin Class ATimeManager Function DisableTimeReverseAbility
...
// End Class ATimeManager Function DisableTimeReverseAbility

// Begin Class ATimeManager Function EnableTimeReverseAbility
struct Z_Construct_UFunction_ATimeManager_EnableTimeReverseAbility_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Enable controls\n" },
#endif
		{ "ModuleRelativePath", "Public/TimeManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Enable controls" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
...
// End Class ATimeManager Function EnableTimeReverseAbility
...
// Begin Class ATimeManager Function GetAbilityAvailable
struct Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics
{
	struct TimeManager_eventGetAbilityAvailable_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
...
void Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((TimeManager_eventGetAbilityAvailable_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(TimeManager_eventGetAbilityAvailable_Parms), &Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATimeManager, nullptr, "GetAbilityAvailable", nullptr, nullptr, Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::PropPointers), sizeof(Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::TimeManager_eventGetAbilityAvailable_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::Function_MetaDataParams), Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::TimeManager_eventGetAbilityAvailable_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ATimeManager_GetAbilityAvailable()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATimeManager_GetAbilityAvailable_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ATimeManager::execGetAbilityAvailable)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->GetAbilityAvailable();
	P_NATIVE_END;
}
// End Class ATimeManager Function GetAbilityAvailable

// Begin Class ATimeManager Function GetCurrentReversableTime
...
// End Class ATimeManager Function GetCurrentReversableTime
...
void ATimeManager::StaticRegisterNativesATimeManager()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetAbilityAvailable", &ATimeManager::execGetAbilityAvailable },
...
struct Z_Construct_UClass_ATimeManager_Statics
{
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Current state of ability\n" },
#endif
		{ "ModuleRelativePath", "Public/TimeManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Current state of ability" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_currentRecordedTime_MetaData[] = {
		{ "Category", "TimeManager" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Current actie factor of time\n" },
#endif
		{ "ModuleRelativePath", "Public/TimeManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Current actie factor of time" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_timeReversalAbilityEnabled_MetaData[] = {
		{ "Category", "TimeManager" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// State helper\n" },
#endif
		{ "ModuleRelativePath", "Public/TimeManager.h" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_normalTimeFactor_MetaData[] = {
		{ "Category", "TimeManager" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Global ability preset\n" },
#endif
		{ "ModuleRelativePath", "Public/TimeManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Global ability preset" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_reverseTimeThreshold_MetaData[] = {
		{ "Category", "TimeManager" },
		{ "ModuleRelativePath", "Public/TimeManager.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_reverseTimeMaximum_MetaData[] = {
		{ "Category", "TimeManager" },
		{ "ModuleRelativePath", "Public/TimeManager.h" },
	};
#endif // WITH_METADATA
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ATimeManager_DisableTimeReverseAbility, "DisableTimeReverseAbility" }, // 83651292
		{ &Z_Construct_UFunction_ATimeManager_EnableTimeReverseAbility, "EnableTimeReverseAbility" }, // 2971187193
		{ &Z_Construct_UFunction_ATimeManager_EndTimeReverse, "EndTimeReverse" }, // 243649565
		{ &Z_Construct_UFunction_ATimeManager_GetAbilityAvailable, "GetAbilityAvailable" }, // 2149139674
		{ &Z_Construct_UFunction_ATimeManager_GetCurrentReversableTime, "GetCurrentReversableTime" }, // 2131029696
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATimeManager_Statics::NewProp_currentRecordedTime = { "currentRecordedTime", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATimeManager, currentRecordedTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_currentRecordedTime_MetaData), NewProp_currentRecordedTime_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATimeManager_Statics::NewProp_reverseTimeThreshold = { "reverseTimeThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATimeManager, reverseTimeThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_reverseTimeThreshold_MetaData), NewProp_reverseTimeThreshold_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATimeManager_Statics::NewProp_reverseTimeMaximum = { "reverseTimeMaximum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATimeManager, reverseTimeMaximum), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_reverseTimeMaximum_MetaData), NewProp_reverseTimeMaximum_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Users_osama_Downloads_Unreal_Engine_5_Practice_UnrealPractice_Source_UnrealPractice_Public_TimeManager_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATimeManager, ATimeManager::StaticClass, TEXT("ATimeManager"), &Z_Registration_Info_UClass_ATimeManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATimeManager), 4246097241U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_osama_Downloads_Unreal_Engine_5_Practice_UnrealPractice_Source_UnrealPractice_Public_TimeManager_h_3357217736(TEXT("/Script/UnrealPractice"),
