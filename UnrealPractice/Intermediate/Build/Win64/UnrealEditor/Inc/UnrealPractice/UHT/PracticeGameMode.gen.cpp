...
struct Z_Construct_UClass_APracticeGameMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_customXPPawnClass_MetaData[] = {
		{ "Category", "PracticeGameMode" },
		{ "ModuleRelativePath", "Public/PracticeGameMode.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FClassPropertyParams NewProp_customXPPawnClass;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_APracticeGameMode_Statics::NewProp_customXPPawnClass = { "customXPPawnClass", nullptr, (EPropertyFlags)0x0044000002000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APracticeGameMode, customXPPawnClass), Z_Construct_UClass_UClass, Z_Construct_UClass_AXPPawn_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_customXPPawnClass_MetaData), NewProp_customXPPawnClass_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APracticeGameMode_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APracticeGameMode_Statics::NewProp_customXPPawnClass,
};
...
struct Z_CompiledInDeferFile_FID_Users_osama_Downloads_Unreal_Engine_5_Practice_UnrealPractice_Source_UnrealPractice_Public_PracticeGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APracticeGameMode, APracticeGameMode::StaticClass, TEXT("APracticeGameMode"), &Z_Registration_Info_UClass_APracticeGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APracticeGameMode), 2593203705U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_osama_Downloads_Unreal_Engine_5_Practice_UnrealPractice_Source_UnrealPractice_Public_PracticeGameMode_h_716562476(TEXT("/Script/UnrealPractice"),
