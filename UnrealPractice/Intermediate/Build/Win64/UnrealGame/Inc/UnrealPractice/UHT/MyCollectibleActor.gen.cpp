...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMyCollectibleActor_Statics::NewProp_lifetime = { "lifetime", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyCollectibleActor, lifetime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_lifetime_MetaData), NewProp_lifetime_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Users_osama_Downloads_Unreal_Engine_5_Practice_UnrealPractice_Source_UnrealPractice_Public_MyCollectibleActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyCollectibleActor, AMyCollectibleActor::StaticClass, TEXT("AMyCollectibleActor"), &Z_Registration_Info_UClass_AMyCollectibleActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyCollectibleActor), 1570633976U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_osama_Downloads_Unreal_Engine_5_Practice_UnrealPractice_Source_UnrealPractice_Public_MyCollectibleActor_h_2604723250(TEXT("/Script/UnrealPractice"),
